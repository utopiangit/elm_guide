...
var author$project$BulHold$Input = {$: 'Input'};
var author$project$BulHold$Model = F7(
	function (user, date, category, amount, memo, shoppings, tab) {
		return {amount: amount, category: category, date: date, memo: memo, shoppings: shoppings, tab: tab, user: user};
	});
var author$project$BulHold$initialShopping = A5(author$project$BulHold$Model, 'Chacha', '', 'Food', '', '');
...
var author$project$BulHold$init = A2(author$project$BulHold$initialShopping, _List_Nil, author$project$BulHold$Input);
var author$project$BulHold$History = {$: 'History'};
var author$project$BulHold$Shopping = F5(
	function (user, date, category, amount, memo) {
		return {amount: amount, category: category, date: date, memo: memo, user: user};
	});
...
var author$project$BulHold$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'InputUser':
				var user = msg.a;
			...
			case 'Submit':
				return A2(
					author$project$BulHold$initialShopping,
					A2(
						elm$core$List$cons,
						A5(author$project$BulHold$Shopping, model.user, model.date, model.category, model.amount, model.memo),
						model.shoppings),
					author$project$BulHold$Input);
			case 'Delete':
				var n = msg.a;
				var t = model.shoppings;
				return _Utils_update(
					model,
					{
						shoppings: _Utils_ap(
			...
			case 'InputTab':
				return _Utils_update(
					model,
					{tab: author$project$BulHold$Input});
			default:
				return _Utils_update(
					model,
					{tab: author$project$BulHold$History});
		}
	});
...
var author$project$BulHold$myColumnModifiers = F2(
...
var author$project$BulHold$demoSection = F3(
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					A2(
						author$project$BulHold$myColumnModifiers,
...
var author$project$BulHold$Delete = function (a) {
	return {$: 'Delete', a: a};
};
...
var author$project$BulHold$rowShopping = function (_n0) {
	var n = _n0.a;
	var shopping = _n0.b;
	return A3(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(shopping.date)
					])),
				A2(
				surprisetalk$elm_bulma$Bulma$Elements$tableCell,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(shopping.user)
					])),
				A2(
				surprisetalk$elm_bulma$Bulma$Elements$tableCell,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(shopping.category)
					])),
				A2(
				surprisetalk$elm_bulma$Bulma$Elements$tableCell,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(shopping.amount)
					])),
				A2(
				surprisetalk$elm_bulma$Bulma$Elements$tableCell,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(shopping.memo)
					])),
				A2(
				surprisetalk$elm_bulma$Bulma$Elements$tableCell,
				_List_Nil,
				_List_fromArray(
					[
						...
						_Utils_update(
							...
							{color: surprisetalk$elm_bulma$Bulma$Modifiers$Light, size: surprisetalk$elm_bulma$Bulma$Modifiers$Small}),
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$BulHold$Delete(n))
							]),
						_List_Nil,
						_List_fromArray(
							[
...
var surprisetalk$elm_bulma$Bulma$Elements$table = function (_n0) {
	var bordered = _n0.bordered;
	var striped = _n0.striped;
	var narrow = _n0.narrow;
	var hoverable = _n0.hoverable;
...
var surprisetalk$elm_bulma$Bulma$Elements$tableModifiers = {bordered: false, fullWidth: false, hoverable: false, narrow: false, striped: false};
var author$project$BulHold$tableShopping = function (hist) {
	return A3(
		surprisetalk$elm_bulma$Bulma$Elements$table,
		surprisetalk$elm_bulma$Bulma$Elements$tableModifiers,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				...
				A3(
				elm$core$Basics$composeL,
				surprisetalk$elm_bulma$Bulma$Elements$tableBody(_List_Nil),
				elm$core$List$map(author$project$BulHold$rowShopping),
				A2(elm$core$List$indexedMap, elm$core$Tuple$pair, hist))
			]));
};
...
var author$project$BulHold$historyView = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(
						author$project$BulHold$demoSection,
						'Shopping History',
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Recent expenses..')
											]))
									])),
								author$project$BulHold$tableShopping(model.shoppings)
							]))
					]))
			]));
};
var author$project$BulHold$InputAmount = function (a) {
	return {$: 'InputAmount', a: a};
};
var author$project$BulHold$InputCategory = function (a) {
	return {$: 'InputCategory', a: a};
};
var author$project$BulHold$InputDate = function (a) {
	return {$: 'InputDate', a: a};
};
var author$project$BulHold$InputMemo = function (a) {
	return {$: 'InputMemo', a: a};
};
var author$project$BulHold$InputUser = function (a) {
	return {$: 'InputUser', a: a};
};
var author$project$BulHold$Submit = {$: 'Submit'};
...
var author$project$BulHold$inputForm = function (model) {
	return A3(
		surprisetalk$elm_bulma$Bulma$Layout$section,
		surprisetalk$elm_bulma$Bulma$Layout$NotSpaced,
		_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Who you are')
											])),
										A4(
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onInput(author$project$BulHold$InputUser)
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onInput(author$project$BulHold$InputDate)
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onInput(author$project$BulHold$InputCategory)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$text('Transportation')
													])),
												A2(
												elm$html$Html$option,
												_List_Nil,
												...
												_List_fromArray(
													[
														elm$html$Html$text('Gas, Water, Electric, e.t.c.')
													])),
												A2(
												elm$html$Html$option,
												_List_Nil,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('How much it is')
											])),
										A4(
										surprisetalk$elm_bulma$Bulma$Form$controlInput,
										surprisetalk$elm_bulma$Bulma$Form$controlInputModifiers,
										_List_fromArray(
											[
												elm$html$Html$Events$onInput(author$project$BulHold$InputAmount)
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onInput(author$project$BulHold$InputMemo)
											]),
										_List_fromArray(
											[
												elm$html$Html$Attributes$placeholder('What you bought / Where you bought it e.t.c.'),
												elm$html$Html$Attributes$value(model.memo)
											]),
										_List_Nil)
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(author$project$BulHold$Submit)
											]),
										_List_Nil,
										_List_fromArray(
											[
...
var author$project$BulHold$contentView = function (model) {
	var _n0 = model.tab;
	if (_n0.$ === 'Input') {
		return author$project$BulHold$inputForm(model);
	} else {
		return author$project$BulHold$historyView(model);
	}
};
...
var author$project$BulHold$fontAwesomeCDN = A3(
	elm$html$Html$node,
	'link',
	_List_fromArray(
		[
	...
	_List_Nil);
var author$project$BulHold$HistoryTab = {$: 'HistoryTab'};
var author$project$BulHold$InputTab = {$: 'InputTab'};
...
var surprisetalk$elm_bulma$Bulma$Modifiers$Centered = {$: 'Centered'};
var author$project$BulHold$tabsView = function (model) {
	return A4(
		surprisetalk$elm_bulma$Bulma$Components$tabs,
		_Utils_update(
			surprisetalk$elm_bulma$Bulma$Components$tabsModifiers,
			{alignment: surprisetalk$elm_bulma$Bulma$Modifiers$Centered, style: surprisetalk$elm_bulma$Bulma$Components$Minimal}),
		_List_Nil,
		_List_Nil,
		_List_fromArray(
			[
				...
				_Utils_eq(model.tab, author$project$BulHold$Input),
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$BulHold$InputTab)
					]),
				_List_Nil,
				_List_fromArray(
					[
				...
				A4(
				surprisetalk$elm_bulma$Bulma$Components$tab,
				_Utils_eq(model.tab, author$project$BulHold$History),
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$BulHold$HistoryTab)
					]),
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('fa fa-history')
									]),
								_List_Nil)
							])),
...
var author$project$BulHold$topHero = A3(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('HouseHold app')
								]))
						]))
				]))
		]));
...
var surprisetalk$elm_bulma$Bulma$CDN$stylesheet = A3(
	...
	_List_Nil);
var author$project$BulHold$view = function (model) {
	return A2(
		elm$html$Html$main_,
		_List_Nil,
		_List_fromArray(
			[
				...
				author$project$BulHold$fontAwesomeCDN,
				author$project$BulHold$topHero,
				author$project$BulHold$tabsView(model),
				author$project$BulHold$contentView(model)
			]));
};
...
var author$project$BulHold$main = elm$browser$Browser$sandbox(
	{init: author$project$BulHold$init, update: author$project$BulHold$update, view: author$project$BulHold$view});
_Platform_export({'BulHold':{'init':author$project$BulHold$main(
